...
// Customer accounts are created only through Google sign-in — see POST /api/auth/customer/google.
// (The old emailed-code signup routes were removed so an account can't be made by typing an email.)
